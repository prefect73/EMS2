...
<body>
	<div class="generic-container">
		...
		<c:choose>
			<c:when test="${edit}">
				<div class="well lead col-md-5">Update Employee</div>
			...
			<c:otherwise>
				<div class="well lead col-md-5">Add Employee</div>
				<div class="well col-md-2">
		...
		<form:form method="POST" modelAttribute="user" class="form-horizontal">
			...
			<div class="row">
				<div class="form-group col-md-12">
					<label class="col-md-2 control-lable" for="email">Per Month
						Cost</label>
					<div class="col-md-3">
						<form:input type="text" path="perMonthCost" id="perMonthCost"
							class="form-control input-sm" />
						<div class="has-error">

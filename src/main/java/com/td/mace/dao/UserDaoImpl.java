...
public class UserDaoImpl extends AbstractDao<Integer, User> implements UserDao {
	...
	public List<User> findAllUsersByType(String userProfileType) {
		Query query = getCurrentSession().createSQLQuery("select au.* from app_user au , app_user_user_profile auup , user_profile up where au.id = auup.user_id and auup.user_profile_id = up.id  and up.type = :type").addEntity(User.class);
